...
### Solution Apr 13, 2025 (C++, leetcode) 1922. Count Good Numbers (Medium)
In .LeetcodeDailySolution folder as Apr13,2025.cpp
...
Runtime: 0 ms, beating 100% of leetcode users solutions using C++.
Memory: 7.89 mb, beating 69.21% of leetcode users solutions using C++.

#### Concepts Applied:

While loop, if statement, and else statement.
